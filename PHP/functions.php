...
function getName($id){ // Get Customer name using it's ID
    $userNameSQL = "SELECT customer_name FROM customer WHERE customer_id = " . $id;
...
function getIdFromName($name) {
    $userIdSQL = "SELECT customer_id FROM customer WHERE customer_name = '" . DB()->real_escape_string($name) . "'";
