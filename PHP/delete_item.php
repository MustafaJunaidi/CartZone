...
$sqlITEMS = "SELECT * from item WHERE item_id=$itemID";
...
$SAVEdeleteOperationSQL = "INSERT INTO deleted_items (item_id, item_name, item_price, item_description, item_quantity, item_category)
