...
$sql = "INSERT INTO item (item_name, item_price, item_description, item_quantity, item_category)
VALUES ('$item_name', '$item_price', '$item_description','$item_quantity', '$item_category')";


if (DB()->query("$sql")) {
    $item_id_sql = "SELECT item_id from item where item_name = '$item_name'";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql_image = "UPDATE item SET item_img = '$targetPath' WHERE item_id = '$newest_item_id'";
    DB()->query("$sql_image");
}
